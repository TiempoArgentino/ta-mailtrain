 ...
 * @subpackage Mailtrain_Api/public
 */
...
class Mailtrain_Api_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Mailtrain_Api_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Mailtrain_Api_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/mailtrain-api-public.css', array(), $this->version, 'all' );
